    ...
    <header class="relative min-h-[100vh] flex items-center pt-10 lg:pt-20 overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10 w-full grid gap-16 items-center">
            ...
            <div data-anim-stagger="0.2s">
                ...
                <h1 data-anim="fade-up" class="font-serif text-3xl text-center md:text-7xl font-bold leading-tight mb-3 text-arvaya-100">
                ...
                <div data-anim="fade-up" class="origin-top mt-12 flex items-center gap-4 text-sm text-arvaya-400 w-fit mx-auto">
