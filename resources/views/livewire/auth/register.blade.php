    ...
    <div
        ...
        <div class="relative z-10">
            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-5" x-data="{ showPass: false, showConfirm: false }">
                ...
                <div>
                    <label
                        class="block text-xs font-bold text-[#7C6339] uppercase tracking-wider mb-1.5 ml-1">{{ __('Name') }}</label>
                ...
                <div>
                    <label
                        class="block text-xs font-bold text-[#7C6339] uppercase tracking-wider mb-1.5 ml-1">{{ __('Password') }}</label>
                    <div class="relative">
                ...
                <div>
                    <label
                        class="block text-xs font-bold text-[#7C6339] uppercase tracking-wider mb-1.5 ml-1">{{ __('Confirm password') }}</label>
                    <div class="relative">
