...
{{-- MAIN CONTENT --}}
<div class="bg-[url('/public/img/login.png')] bg-fixed bg-cover relative">
    <div class="relative min-h-screen font-title md:max-w-sm mx-auto shadow-xl shadow-black/80 bg-zinc-900">
        ...
        <section class="min-h-screen relative bg-theme p-4">
            ...
            <div class="absolute top-0 left-0 w-full h-full bg-radial from-black/20 via-black/70 to-black z-10">
            </div>
            ...
            <div
                ...
                <div>
                    <h1 class="font-title text-2xl text-center text-white/70 animate-float">Wedding Invitation</h1>
                </div>
        ...
        <section class="bg-zinc-900 px-6 py-10  shadow-inset space-y-5">
            ...
            <div>
                <div data-anim="fade-left" class="w-full text-center p-3">
            ...
            <section class="min-h-screen bg-zinc-900 px-6 py-16 space-y-5">
                ...
                @if(!empty($invitation->event_data) && is_array($invitation->event_data))
                    @foreach($invitation->event_data as $event)
                        ...
                        @endphp
                        @if($eventDate)
                            <div class="text-center space-y-6" data-anim="fade-up">
                                <div
        ...
        @if($isDressCodeEnabled)
            <section
                ...
                <div class="text-center max-w-lg mx-auto" data-anim="fade-up">
                    ...
                    <div class="text-center" data-anim="fade-up">
                        ...
                        <div class="space-y-6">
                            @foreach ($gifts as $gift)
                                <div
                                    class="relative w-full max-w-[340px] mx-auto aspect-[1.58/1] rounded-2xl overflow-hidden shadow-[0_15px_40px_-5px_rgba(0,0,0,0.8)] transform transition duration-500 hover:scale-[1.02] group">
        ...
        {{-- RSVP FORM --}}
        @if($hasRsvp)
            <div class="pt-10 p-6 rounded-lg shadow-inset" data-anim="fade-up">
        ...
        {{-- WISHES --}}
        @if($hasGuestbook)
            <div class="pt-10 p-6" data-anim="fade-up">
        ...
        {{-- 5. THANK YOU MESSAGE --}}
        <section class="relative py-20 px-6 bg-neutral-950 overflow-hidden">
            <div
        ...
        <footer class="bg-black py-12 text-center border-t border-gold/20">
            ...
            <a href="https://arvaya.id" target="_blank" class="font-sans text-[10px] text-white/30 uppercaseatracking-[0.3em]">Powered By Arvaya.id</a>
            <div class="mt-4">
